...
namespace Lab1
{
    public partial class WinPrint : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            System.Windows.Forms.DialogResult aResault;
            aForm.printPreviewControl1.Document = printDocument1;
            aResault = aForm.ShowDialog();
            if (aResault == System.Windows.Forms.DialogResult.OK)
                printDocument1.Print();
        }
        ...
        {
            System.Windows.Forms.DialogResult aResault;
            aResault = openFileDialog1.ShowDialog();
            if (aResault == System.Windows.Forms.DialogResult.OK)
            {
